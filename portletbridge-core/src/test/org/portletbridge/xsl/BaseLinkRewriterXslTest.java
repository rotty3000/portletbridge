 ...
 * @author JMcCrindle
 */
public class BaseLinkRewriterXslTest extends TestCase {
        ...
        try {
            ...
            if (tfactory.getFeature(SAXSource.FEATURE))
            {
                ...
                TransformerHandler handler1 = 
                    stfactory.newTransformerHandler(new StreamSource(new File("./src/xsl/org/portletbridge/xsl/baselinkrewriter.xsl")));
                ...
                parser.parse(new InputSource(
                        ...
                        "./src/test/org/portletbridge/xsl/baselinkrewritertest.xml"))));
            }
            else
            {
                System.out.println(
     ...
     * @param arg0
     */
    public BaseLinkRewriterXslTest(String arg0) {
        super(arg0);
    }
