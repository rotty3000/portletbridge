...
/**
 * Implementation of the PortletBridgeMemento for HttpClient (or the Commons
 * ProxyTransport). 
 * 
 * @author jmccrindle
 */
public class CommonsProxyBrowser implements ProxyBrowser {
     ...
     * @see org.portletbridge.portlet.old.PortletBridgeMemento#getCurrentPage()
     */
     ...
     * proxyPort
     * 
     * @see org.portletbridge.portlet.old.PortletBridgeMemento#setPreferences(javax.portlet.PortletPreferences)
     */
